...
const finalString = `        <!-- Container de Projetos -->
        <div class="projetos-container">
            <!-- Social Media -->
            <div class="conteudo-categoria active" data-category="social-media">
                <div class="projetos-grade">
${socialMediaCards}
                </div>
                <!-- Mobile Sticky Cards -->
...
${mobileSocial}
            ...
            <!-- Identidade Visual -->
            <div class="conteudo-categoria" data-category="identidade-visual">
                <div class="projetos-grade">
${visualIdCards}
                </div>
                <!-- Mobile Sticky Cards -->
...
html = html.replace(/<!-- Container de Projetos -->[\s\S]*?<!-- Seção Por Que Escolher -->/m, finalString);
